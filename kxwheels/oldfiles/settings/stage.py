...
ADMINS = (
    ('Nav', 'navaulakh+kxwheels@gmail.com'),
   # ('Clark', 'clark@countable.ca'),
   # ('Benny', 'benny@countable.ca'),
)
...
MIDDLEWARE_CLASSES += (
    ...
    'kx.ThreadLocal.ThreadLocalMiddleware',
...
TEMPLATE_CONTEXT_PROCESSORS += (
    ...
    'context_processors.extract_subdomain',
...
EMAIL_HOST = 'mail.kxwheels.com'
EMAIL_HOST_USER = 'info@kxwheels.com'
#EMAIL_HOST_PASSWORD = 'kari2650'
EMAIL_HOST_PASSWORD = 'W3k2u9@kx12'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
...
# Celery
#BROKER_HOST = "beta2.kxwheels.com"
